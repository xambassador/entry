            ...
            <form {...controls.getFormProps({ className: "space-y-4" })}>
              <div>
                ...
                <input
                  {...controls.getInputProps({
                    ...
                    className:
                      "w-full bg-canvas text-ink placeholder:text-ink-faint border border-border rounded-lg px-4 py-3.5 text-sm focus:outline-none focus:border-accent/50 focus:ring-1 focus:ring-accent/20 disabled:opacity-50 transition-all duration-200 ease-active"
                  })}
                />
              </div>
              ...
              <button
                {...controls.getButtonProps({
                  className:
                    "w-full flex items-center justify-center gap-2 px-4 py-3.5 rounded-lg text-sm font-semibold cursor-pointer select-none disabled:cursor-not-allowed disabled:opacity-60 bg-accent text-canvas hover:brightness-110 active:scale-[0.98] transition-all duration-150 ease-active"
                })}
              >
